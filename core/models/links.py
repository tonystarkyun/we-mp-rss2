...
class Link(Base):
    ...
    id = Column(String(50), primary_key=True, comment='链接ID')
    name = Column(String(200), nullable=False, comment='链接名称')
    url = Column(String(500), nullable=False, unique=True, comment='链接URL')
    avatar = Column(String(500), default='/static/logo.svg', comment='头像URL')
    description = Column(Text, comment='链接描述')
