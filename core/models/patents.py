# core/models/patents.py - 专利检索数据模型
...
class Patent(Base):
    ...
    id = Column(String(50), primary_key=True, comment='专利链接ID')
    name = Column(String(200), nullable=False, comment='专利链接名称')
    url = Column(String(500), nullable=False, unique=True, comment='专利链接URL')
    avatar = Column(String(500), default='/static/logo.svg', comment='头像URL')
    description = Column(Text, comment='专利链接描述')
